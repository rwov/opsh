...
const workflowSteps: WorkflowStep[] = [
  {
    id: "1",
    agent: "find all pdfs modified this week",
    tokens: "",
    status: "find . -type f -name '*.pdf' -mtime -7 -print0",
    step: "",
  },
  {
    id: "2",
    agent: "which of those pdfs are bigger than 10MB?",
    tokens: "",
    status: "find . -type f -name '*.pdf' -size +10M -print0",
    step: "",
  },
  {
    id: "3",
    agent: "move pdfs smaller than 10MB to a different folder",
    tokens: "",
    status:
      "find . -type f -name '*.pdf' -size -10M -exec mv {} /path/to/destination/ \\;",
    step: "",
  },
];
