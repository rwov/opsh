    ...
    <div className="group w-full max-w-3xl">
      ...
      <div className="relative rounded-r-2xl rounded-b-2xl border border-border bg-background p-5 md:p-6">
        <Button
          type="button"
          onClick={handleCopy}
          className="absolute right-3 top-3 rounded-lg border border-border bg-background text-foreground opacity-0 shadow-none transition-opacity hover:bg-muted group-hover:opacity-100"
          variant="ghost"
        >
          {copied ? "Copied" : "Copy"}
        </Button>
